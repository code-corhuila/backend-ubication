...
# ⬇️ único cambio: usar el archivo histórico de Apache
...
CMD java -jar /app-compiled/target/BackendUbication-0.0.1-SNAPSHOT.jar && exec /bin/bash -c "trap : TERM INT; sleep infinity & wait"
